...
void skills () {
  ...
  intake.controllerSet(0);
  blooper.set_value(0);
  fastDriveToPoint(7, 0.9, false);
  imuTurnToAngle(78);
  intake.controllerSet(1);
  relative(3, 0.25, 4);
  jCurve(6.9, 0.8, false);
  imuTurnToAngle(10);
  compression1.set_value(1);
  intake.controllerSet(-1);
  pros::delay(1200);
  ...
  relative(-2, 0.7, 0.2);
  relative(-2, 0.3, 0.5);
  jCurve(8, 8.7, true, 0, 0.7, 0.7);
  jCurve(8, 8.7, true, 0, 0.3);
  jCurve(9, 8.7, false, 0, 1);
  imuTurnToAngle(-90);
  intake.controllerSet(1);
  relative(-3, 0.7, 0.8);
  relative(-2, 0.3, 0.5);
  ...
  compression1.set_value(0);
  intake.controllerSet(1);
  fastDriveToPoint(9, 7);
  fastDriveToPoint(7, 5);
  imuTurnToAngle(145);
  compression1.set_value(1);
  intake.controllerSet(-0.3);
  pros::delay(2000);
  ...
  speed = 600;
  intake.controllerSet(1);
  fastDriveToPoint(4, 2, true, 0, 0.7, 0.7);
  fastDriveToPoint(4, 2, true, 0, 0.3, 0.7);
  imuTurnToAngle(90);
  compression1.set_value(1);
