...
void skills () {
  ...
  intake.controllerSet(1);
  speed = 460;
  fastDriveToPoint(4.9, 2.8, true, 0, 1, 0.8);
  ...
  intake.controllerSet(1);
  compression1.set_value(0);
  fastDriveToPoint(10.9, 8.9, true, 0, 0.7, 2.5);
  imuTurnToAngle(180);
  relative(-2, 0.7, 0.2);
  relative(-2, 0.3, 0.5);
  jCurve(10, 6, true, 0, 1, 1);
  imuTurnToAngle(-85);
  compression1.set_value(1);
  intake.controllerSet(-0.3);
  pros::delay(2000);
  intake.controllerSet(1);
  compression1.set_value(0);
  fastDriveToPoint(9.7, 10.5, true, 0, 0.55);
  imuTurnToAngle(-90);
  intake.controllerSet(1);
  relative(-2, 0.5, 0.4);
  relative(-2, 0.3, 0.5);
  ...
  intake.controllerSet(0);
  relative(1, 1, 0.7);
  fastDriveToPoint(6.3, 11, true, 0, 1, 1);
  imuTurnToAngle(-180);
  compression1.set_value(1);
  intake.controllerSet(-0.3);
  pros::delay(2000);
  compression1.set_value(0);
  intake.controllerSet(1);
  fastDriveToPoint(7.6, 9.4, true, 0, 1, 0.7);
  fastDriveToPoint(5.5, 7.5, true, 0, 1, 0.9);
  imuTurnToAngle(120);
  compression1.set_value(1);
  intake.controllerSet(-0.3);
  pros::delay(2000);
  ...
  speed = 600;
  intake.controllerSet(1);
  fastDriveToPoint(2, 4.6, true, 0, 0.55, 2.5);
  imuTurnToAngle(90);
  compression1.set_value(1);
  ...
  compression1.set_value(0);
  intake.controllerSet(-0);
  fastDriveToPoint(1.4, 2.5, false);
  imuTurnToAngle(45);
